...
public class StockDataTest extends TestCase
{
	...
	public void testWFCStockStatATPData() { 
		String ticker = "LEHLQ";
		StockData sd = new StockData(ticker);
		String actual = (String) sd.getStockStats().get("ANNNUALTARGETPRICE");
		BigDecimal expected = null;
		try {
			expected = YahooFinance.get(ticker).getStats().getOneYearTargetPrice();
		} catch (IOException e) {
			e.printStackTrace();
		}
		assertEquals(expected,actual);
	...
	public void testBXVolumeLastIndexGetStockHistoricalTradesInputs(){
		String ticker = "BX";
		StockData bx = new StockData(ticker);
		Calendar from = new GregorianCalendar(2011,0,1);
		Calendar to = new GregorianCalendar(2020,7,21);
		...
		Long expected = listOfTrades.get(listOfTrades.size()-1).getVolume();
		Map actualMap = (Map) bx.getStockHistoricalTrades(from,to,Interval.DAILY).get(simpleDate);
		Long actual = (Long) actualMap.get("VOLUME");
		assertEquals(actual,expected);
	}
	
	public void testBXHighMiddleIndexGetStockHistoricalTradesInput(){
		String ticker = "BX";
		StockData bx = new StockData(ticker);
		Calendar from = new GregorianCalendar(2005,0,1);
		Calendar to = new GregorianCalendar(2009,0,1);
		List<HistoricalQuote> listOfTrades = null;
		 try {
			listOfTrades = YahooFinance.get(ticker).getHistory(from,to,Interval.DAILY);
		 } catch (IOException e) {
	...
	public void testBXLowMiddleIndexGetStockHistoricalTradesInput(){
		String ticker = "BX";
		StockData bx = new StockData(ticker);
		Calendar from = new GregorianCalendar(2005,0,1);
		Calendar to = new GregorianCalendar(2009,0,1);
	...
	public void testBXCloseMiddleIndexGetStockHistoricalTradesInput(){
		String ticker = "BX";
		StockData bx = new StockData(ticker);
		Calendar from = new GregorianCalendar(2005,0,1);
		Calendar to = new GregorianCalendar(2009,0,1);
	...
	public void testBXOpenMiddleIndexGetStockHistoricalTradesInput(){
		String ticker = "BX";
		StockData bx = new StockData(ticker);
		Calendar from = new GregorianCalendar(2005,0,1);
		Calendar to = new GregorianCalendar(2009,0,1);
	...
	public void testBXVolumeMiddleIndexGetStockHistoricalTradesInput(){
		String ticker = "BX";
		StockData bx = new StockData(ticker);
		Calendar from = new GregorianCalendar(2005,0,1);
		Calendar to = new GregorianCalendar(2009,0,1);
